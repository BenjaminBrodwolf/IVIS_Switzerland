const steps = [
    {nr: 1, img: "step1.gif", text: "Setzen Sie als erstes die gewünschten Werte der Properties, welche Sie analysieren möchten"},
    {nr: 2, img: "step2.gif", text: "Ziehen Sie die die gewünschten Properties in die Filterzone"},
    {nr: 3, img: "step3.gif", text: "Mit dem Klick auf eine der gefundenen Gemeinden in der rechten Tabelle, zoomt man zu der Gemeinde hin"},
    {nr: 4, img: "step4.gif", text: "Mit dem Klick auf die selektierte Gemeinde gelangt man wieder auf die Gesamtübersicht der Karte"}
]
